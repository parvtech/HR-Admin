    ...
    return (
        <>
            ...
            <Modal className='mt-3 pt-3 d-flex justify-content-between self-align-start' show={true}>
                <Modal.Body  className='bg-white rounded ' style={{width: "700px", height: '620px'}}>
                    <div className='container'>
                        <div className='row'>
                            <div className=''></div>
                            <div className='col-12 mt-0 d-flex justify-content-center'>
                                <div className="" style={{ width: "1500px", height: "500px" }}>
                                <form onSubmit={handleSubmit} className=''>
                                    ...
                                    <div className="text-center mt-0 ">
                                        ...
                                        <p className='h3medium mt-0'>Profile Information</p>
